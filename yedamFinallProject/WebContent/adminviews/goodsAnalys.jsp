...
function drawDonutChart1(d1,d2){
	...
	$.ajax("AdminAjaxGoodsAnalysQyOk.ad",{dataType:"json", data:{startDate:d1, endDate:d2}})
	.done(function(cData){		
	console.log(cData);		
	...
	var data1 = {
	    ...
	    series: [
	    	  {
		            name: cData[0].goods_name,
		            data: cData[0].percent
		        },
		        {
		            name: cData[1].goods_name,
		            data: cData[1].percent
		        },
		        {
		            name: cData[2].goods_name,
		            data: cData[2].percent
		        },
		        {
		            name: cData[3].goods_name,
		            data: cData[3].percent
		        },
		        {
		            name: cData[4].goods_name,
		            data: cData[4].percent
		        },
		        {
		            name: cData[5].goods_name,
		            data: cData[5].percent
		        },
		        {
		            name: cData[6].goods_name,
		            data: cData[6].percent
		        },
		        {
		            name: cData[7].goods_name,
		            data: cData[7].percent
		        },
		        {
		            name: cData[8].goods_name,
		            data: cData[8].percent
		        },
		        {
		            name: cData[9].goods_name,
	...
	for(var i = 0; i <cData.length; i++){
		var tr1 = $("<tr>");
		var num = $("<td>").text(i+1);	    		
		var td1 = $("<td>").text(cData[i].goods_name);
		var td2 = $("<td>").text(cData[i].qy_sum +" 개");
...
function drawDonutChart2(d1,d2){
	...
	$.ajax("AdminAjaxGoodsAnalysAmountOk.ad",{dataType:"json", data:{startDate:d1, endDate:d2}})
	.done(function(cData){		
	console.log(cData);		
				...
				<div class="col-md-2">
					<nav aria-label="breadcrumb" role="navigation">
					  <ol class="breadcrumb">
		    			...
		    			<li class="breadcrumb-item active" aria-current="page">상품별 분석 통계</li>		    			
		  			 </ol>
					</nav>
				</div>
			</div>
				...
				<div class="card-header">
					...
					<div class="col-md-12">
						  <ul class="nav nav-tabs" role="tablist">
						    <li class="nav-item">
							      <a class="nav-link active"href="">상품별</a>
						    </li>
						    <li class="nav-item">
							      <a class="nav-link" href="AdminSellerAnalysis.ad">판매자별</a>
						    </li>								    
						  </ul>	
					</div>
				</div>
