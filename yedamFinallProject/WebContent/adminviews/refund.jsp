...
<body>
	<form id="frm" name="frm" method="post" action="AdminRefundOk.ad" onsubmit="return fromCheck()">
							...
							<div class="col-md-4">
								<nav aria-label="breadcrumb" role="navigation">
								  <ol class="breadcrumb">
					    			...
					    			<li class="breadcrumb-item active" aria-current="page">결제 환불 관리</li>		    			
					  			 </ol>
								</nav>
							</div>
						</div>
			...
			<div class="col-md-12">
				...
				<div class="card">
					<div class="card-header">
						<h6 class="card-title">환불 정보 검색</h6>
						<hr>						
					</div>
					<div class="card-body"> <!-- 첫번째 카드 바디 시작 -->
						<div class="row ">
							...
							<div class="col-md-2 pt-2 row-st">
								<select class="custom-select"  id="ctg1" name="ctg1">
									<option value="setleId" selected >주문번호</option>									
						...
						<div class="row ">
							<div class="col-md-1 pt-3 row-st">
								환불상태
							</div>
							<div class="col-md-1 row-st">
								<div class="custom-control custom-checkbox">
								  <input type="checkbox" class="custom-control-input" id="r_all" name="chk" value="all">
								  <label class="custom-control-label" for="r_all">전체</label>
								</div>
							</div>
							<div class="col-md-1 row-st">
								<div class="custom-control custom-checkbox">
								  <input type="checkbox" class="custom-control-input" id="r_request" name="chk" value="request">
								  <label class="custom-control-label" for="r_request">환불신청</label>
								</div>

							</div>
							<div class="col-md-1 row-st">
								<div class="custom-control custom-checkbox">
								  <input type="checkbox" class="custom-control-input" id="r_complete" name="chk" value="complete">
								  <label class="custom-control-label" for="r_complete">환불완료</label>
								</div>
							</div>
	...
	<script>	
	 $( "#startDate" ).datepicker({
	    ...
	    if(${rfDto != null}){		
	    	$("select[name='ctg1']").val(['${rfDto.sCtg}']);
	    	$("[name='s_word1']").val(['${rfDto.name1}']);
	    	$("[name='ctg2']").val(['${rfDto.sCtg2}']);
	    	$("[name='s_word2']").val(['${rfDto.name2}']);
	    	$("[name='startDate']").val(['${rfDto.sDate}']);
	    	$("[name='endDate']").val(['${rfDto.eDate}']);	    					    		 	 	
	    	$("[name='chk']").val(['${rfDto.stat}']); 
	    	$("[name='sort']").val(['${rfDto.sort}']);
