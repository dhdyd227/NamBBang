			...
			<div align="center">
				<form id="frm" name="frm" action="./boardWriteOK.do" method="post"
					...
					<table>
						<tr height="30">
							<th>*ID(사업자번호)</th>
							<td><input style="width: 660px;" type="text"
								class="sid_input" id="sid" name="sid">
						...
						<tr height="30">
							<th>*상호명</th>
							<td><input style="width: 730px;" type="text" id="sname"
								name="sname"></td>
						</tr>
						<tr height="30">
							<th>*가게위치</th>
							<td><input style="width: 690px;" type="text" id="lc"
								name="lc">
								<button id="button" onclick="fn_setAddr();">검색</button></td>
						</tr>
						<tr height="30">
							<th>*사업주</th>
							<td><input style="width: 730px;" type="text" id="name"
								name="name"></td>
						</tr>
						<tr height="30">
							<th>*전화번호</th>
							<td><input style="width: 730px;" type="text" id="no"
								name="no"></td>
						</tr>
						<tr height="30">
							<th>*영업시작시간</th>
							<td><input style="width: 730px;" type="Time" id="open"
								name="open"></td>
						</tr>
						<tr height="30">
							<th>*영업마감시간</th>
							<td><input style="width: 730px;" type="Time" id="close"
								name="close"></td>
						</tr>
						<tr height="30">
							<th>sns주소</th>
							<td><input style="width: 730px;" type="text" id="sns"
								name="sns"></td>
						</tr>
						<tr height="30">
							<th>*가게소개글</th>
							<td colspan="3"><textarea style="width: 730px; resize: none"
									id="intrcn" name="intrcn" cols="60" rows="15"></textarea></td>
						</tr>
					</table>
					<div class="mt-3">
