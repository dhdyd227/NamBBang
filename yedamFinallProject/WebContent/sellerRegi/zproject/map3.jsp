...
<body>
    ...
    <script type="text/javascript"
        src="//dapi.kakao.com/v2/maps/sdk.js?appkey=005ea4d937e6376ccc6a5662ec842815&libraries=services"></script>
    <script>
        var mapContainer = document.getElementById('map'), // 지도를 표시할 div 
        mapOption = {
            center : new daum.maps.LatLng(35.870634, 128.589452), // 지도의 중심좌표
            level : 4
        // 지도의 확대 레벨
        };
