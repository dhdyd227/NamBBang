...
<script src="https://kit.fontawesome.com/466f6d08a6.js"
...
<footer class="footer">
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-4 text-center cell-med">대구광역시 중구 상서동 22-2
					5F</div>
				<div class="col-md-4 text-center cell-tall">
					<i class='fab fa-facebook-square' style='font-size: 36px'></i> <i
						class='fab fa-twitter-square' style='font-size: 36px'></i> <i
